...
export default function selectControl(WrapperComponent) {

	return React.createClass({

		displayName: WrapperComponent.displayName || WrapperComponent.name,
		...
		componentWillMount() {
			...
			this.controlApi = {};
			ControlApi.forEach(fn => this.controlApi[fn] = this[fn]);
		...
		render() {
			...
			this.props.multi && !this.props.disabled &&
			valueArray.length && !this.state.inputValue &&
			this.state.isFocused && this.props.backspaceRemoves);
			const removeMessage = !showRemoveMessage ? null : (
