...
// TODO: define a public API for Select renderer components, these are all the methods needed by default:
const MethodsToBind = [
	'handleTouchOutside',
	'getOptionLabel',
	'handleValueClick',
...
export default class SelectBase extends Component {
	constructor(props) {
		...
		MethodsToBind.forEach(fn => this[fn] = this[fn].bind(this));
	}
...
SelectBase.Async = Async;
SelectBase.AsyncCreatable = AsyncCreatable;
SelectBase.Creatable = Creatable;
