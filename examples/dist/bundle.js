...
var ControlApi = ['clearValue', 'getOptionLabel', 'getId', 'focusOption', 'handleInputBlur', 'handleInputChange', 'handleInputFocus', 'handleKeyDown', 'handleMenuScroll', 'handleMouseDown', 'handleMouseDownOnArrow', 'handleMouseDownOnMenu', 'handleTouchEnd', 'handleTouchStart', 'handleTouchMove', 'handleTouchEndClearValue', 'handleValueClick', 'onControlRef', 'onOptionRef', 'onMenuRef', 'onMenuContainerRef', 'onWrapperRef', 'selectValue', 'removeValue'];

function SelectControl(WrapperComponent) {
	...
	return _react2['default'].createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			this.controlApi = {};
			ControlApi.forEach(function (fn) {
				return _this.controlApi[fn] = _this[fn];
			});
		...
		getId: function getId() {
			...
			return ['react-select-' + this._instanceId].concat(args).join('-');
		},
   ...
   */
		...
		onControlRef: function onControlRef(ref) {
			this.control = ref;
		},
		...
		onMenuContainerRef: function onMenuContainerRef(ref) {
			this.menuContainer = ref;
		},

		onMenuRef: function onMenuRef(ref) {
			this.menu = ref;
		},

		onWrapperRef: function onWrapperRef(ref) {
			this.wrapper = ref;
		},
		...
		render: function render() {
			...
			var showRemoveMessage = this.props.multi && !this.props.disabled && valueArray.length && !this.state.inputValue && this.state.isFocused && this.props.backspaceRemoves;
			var removeMessage = !showRemoveMessage ? null : this.props.backspaceToRemoveMessage.replace('{label}', valueArray[valueArray.length - 1][this.props.labelKey]);

			var props = _extends({}, this.props, this.state, this.controlApi, {
				hiddenField: this.renderHiddenField(valueArray),
			...
			return _react2['default'].createElement(WrapperComponent, props);
		}
...
var Select = _react2['default'].createClass({
	...
	renderValue: function renderValue(valueArray, isOpen) {
		...
		var renderLabel = this.props.valueRenderer || this.props.getOptionLabel;
		var ValueComponent = this.props.valueComponent;
		if (!valueArray.length) {
			return !this.props.inputValue ? _react2['default'].createElement(
				'div',
				{ className: 'Select-placeholder' },
				this.props.placeholder
			) : null;
		}
		var onClick = this.props.onValueClick ? this.props.handleValueClick : null;
		if (this.props.multi) {
			return valueArray.map(function (value, i) {
				return _react2['default'].createElement(
					ValueComponent,
					{
						id: _this.props.getId('value', i),
						instancePrefix: _this.props.getId(),
						disabled: _this.props.disabled || value.clearableValue === false,
						key: 'value-' + i + '-' + value[_this.props.valueKey],
						onClick: onClick,
						onRemove: _this.props.removeValue,
						value: value
					},
					renderLabel(value, i),
					_react2['default'].createElement(
	...
	renderInput: function renderInput(valueArray, focusedOptionIndex) {
		...
		var ariaOwns = (0, _classnames2['default'])((_classNames = {}, _defineProperty(_classNames, this.props.getId('list'), isOpen), _defineProperty(_classNames, this.props.getId('backspace-remove-message'), this.props.multi && !this.props.disabled && this.props.isFocused && !this.props.inputValue), _classNames));
	...
	renderArrow: function renderArrow() {
		var onMouseDown = this.props.handleMouseDownOnArrow;
		var isOpen = this.props.isOpen;
	...
	renderOuter: function renderOuter(options, valueArray, focusedOption) {
		...
		return _react2['default'].createElement(
			'div',
			{ ref: this.props.onMenuContainerRef, className: 'Select-menu-outer',
				style: this.props.menuContainerStyle },
			_react2['default'].createElement(
				'div',
				{ ref: this.props.onMenuRef, role: 'listbox', className: 'Select-menu',
	...
	render: function render() {
		...
		if (this.props.removeMessage) {
			removeMessage = _react2['default'].createElement(
				'span',
				{ id: this.props.getId('backspace-remove-message'), className: 'Select-aria-only',
					'aria-live': 'assertive' },
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'span',
					{ className: 'Select-multi-value-wrapper', id: this.props.getId('value') },
			...
			this.props.isOpen ? this.renderOuter(options, !this.props.multi ? this.props.valueArray : null, this.props.focusedOption) : null
		);
	}

});

exports['default'] = (0, _SelectControl2['default'])(Select);
module.exports = exports['default'];

},{"./Async":1,"./AsyncCreatable":2,"./Creatable":3,"./Option":4,"./SelectControl":5,"./Value":6,"./utils/defaultArrowRenderer":7,"./utils/defaultClearRenderer":8,"./utils/defaultFilterOptions":9,"./utils/defaultMenuRenderer":10,"classnames":undefined,"react":undefined,"react-input-autosize":undefined}]},{},[]);
